...
export class PerfilVigilanteComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private authService: AuthService,private toastr:ToastrService , private usuarioService: UsuarioService, private loadingService: LoadingService) {
